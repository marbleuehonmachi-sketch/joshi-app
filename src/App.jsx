...
const ALL_QUESTIONS = {
  ...
  を: [
    ...
    { id:"wo12", sentence:["ジュース","___","のみます。"],  blank:1, hint:"「たべる」「のむ」のまえにつくよ", answer:"を", choices:["を","は","も","へ"],  image:"🧃" },
    ...
    { id:"wo43", sentence:["まんが","___","よみます。"],  blank:1, hint:"「みる」「よむ」のまえにつくよ",   answer:"を", choices:["を","は","も","へ"],  image:"📕" },
    ...
    { id:"wo48", sentence:["はしご","___","のぼります。"],  blank:1, hint:"「する」「やる」のまえにつくよ",  answer:"を", choices:["を","は","も","へ"],  image:"🪜" },
    { id:"wo49", sentence:["かいだん","___","おります。"],    blank:1, hint:"「する」「やる」のまえにつくよ",  answer:"を", choices:["を","は","も","へ"],  image:"🏢" },
  ...
  に: [
    ...
    { id:"ni2",  sentence:["がっこう","___","いきます。"],    blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🏫" },
    { id:"ni3",  sentence:["いえ","___","かえります。"],      blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🏠" },
    { id:"ni4",  sentence:["びょういん","___","いきます。"],  blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🏥" },
    ...
    { id:"ni7",  sentence:["みぎ","___","まがります。"],      blank:1, hint:"どちらに いくかを あらわすよ",  answer:"に", choices:["に","は","で","も"],  image:"↪️" },
    { id:"ni8",  sentence:["もり","___","はいります。"],      blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🌲" },
    { id:"ni9",  sentence:["つくえ","___","おきます。"],      blank:1, hint:"どこに おくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🪞" },
    { id:"ni10", sentence:["でんしゃ","___","のります。"],    blank:1, hint:"なにに のるかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🚃" },
    { id:"ni11", sentence:["こうえん","___","いきます。"],    blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🌳" },
    { id:"ni12", sentence:["プール","___","はいります。"],    blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🏊" },
    { id:"ni13", sentence:["ベッド","___","ねます。"],        blank:1, hint:"どこで するかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🛏️" },
    { id:"ni14", sentence:["うみ","___","いきます。"],        blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🌊" },
    { id:"ni15", sentence:["やま","___","のぼります。"],      blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"⛰️" },
    { id:"ni16", sentence:["みぎ","___","まがります。"],      blank:1, hint:"どちらに まがるかを あらわすよ", answer:"に", choices:["に","は","で","も"],  image:"➡️" },
    { id:"ni17", sentence:["ひだり","___","まがります。"],    blank:1, hint:"どちらに まがるかを あらわすよ", answer:"に", choices:["に","は","で","も"],  image:"⬅️" },
    { id:"ni18", sentence:["はこ","___","いれます。"],        blank:1, hint:"どこに いれるかを あらわすよ",   answer:"に", choices:["に","は","で","も"],  image:"📦" },
    { id:"ni19", sentence:["かばん","___","しまいます。"],    blank:1, hint:"どこに しまうかを あらわすよ",   answer:"に", choices:["に","は","で","も"],  image:"🎒" },
    { id:"ni20", sentence:["どうぶつえん","___","いきます。"],blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🦁" },
    { id:"ni21", sentence:["としょかん","___","いきます。"],  blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"📖" },
    { id:"ni22", sentence:["スーパー","___","いきます。"],    blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🛒" },
    ...
    { id:"ni26", sentence:["たな","___","おきます。"],        blank:1, hint:"どこに おくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🗄️" },
    { id:"ni27", sentence:["ソファ","___","すわります。"],    blank:1, hint:"どこに すわるかを あらわすよ",   answer:"に", choices:["に","は","で","も"],  image:"🛋️" },
    { id:"ni28", sentence:["きょうしつ","___","はいります。"],blank:1, hint:"どこに はいるかを あらわすよ",  answer:"に", choices:["に","は","で","も"],  image:"🏫" },
    { id:"ni29", sentence:["にほん","___","いきます。"],      blank:1, hint:"どこに いくかを あらわすよ",    answer:"に", choices:["に","は","で","も"],  image:"🗾" },
    ...
    { id:"ni34", sentence:["かみ","___","かきます。"],        blank:1, hint:"どこに かくかを あらわすよ",   answer:"に", choices:["に","は","で","も"],  image:"📄" },
    { id:"ni35", sentence:["みえます","___","てをふります。"],blank:1, hint:"どこに するかを あらわすよ",   answer:"に", choices:["に","は","で","も"],  image:"👋" },
    { id:"ni36", sentence:["えき","___","むかいます。"],    blank:1, hint:"どこに むかうかを あらわすよ",   answer:"に", choices:["に","は","で","も"],  image:"🚉" },
    ...
    { id:"ni49", sentence:["ちず","___","のります。"],        blank:1, hint:"どこに のるかを あらわすよ",   answer:"に", choices:["に","は","で","も"],  image:"🗾" },
    { id:"ni50", sentence:["おんせん","___","はいります。"],  blank:1, hint:"どこに はいるかを あらわすよ",  answer:"に", choices:["に","は","で","も"],  image:"♨️" },
  ],
  で: [
